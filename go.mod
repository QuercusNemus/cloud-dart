...
require (
	...
	github.com/aws/aws-cdk-go/awscdk/v2 v2.18.0 // indirect
	github.com/aws/aws-cdk-go/awscdklambdagoalpha/v2 v2.18.0-alpha.0 // indirect
	...
	github.com/aws/jsii-runtime-go v1.55.1 // indirect
